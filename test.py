...
def numberRecognition(image, low_bound, high_bound):
    ...
    ret, thresh1 = cv2.threshold(res, 0, 255, cv2.THRESH_OTSU | cv2.THRESH_BINARY_INV)
    ...
    for cnt in contours:
        ...
        pytesseract.pytesseract.tesseract_cmd = r'C:\Program Files\Tesseract-OCR\tesseract.exe' #Here replace with Tesseract-OCR path
